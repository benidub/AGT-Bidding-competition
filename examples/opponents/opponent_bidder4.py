...
class BiddingAgent:
    """
    Team: Daniel Consistent Value Bidder V1
    Strategy: Value-Proportional Aggression (Single Focus)
    """
    ...
    def bidding_function(self, item_id: str) -> float:
        ...
        # ---------- Value-Proportional Aggression ----------
        # תמיד נמריא אחוז קבוע מהערך של הפריט
        aggression_factor = 0.75
        bid = my_v * aggression_factor

        # לא להמר יותר מהתקציב או מהערך של הפריט
        bid = min(bid, my_v, self.budget - 0.01)
